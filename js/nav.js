...
const SHARED_TRANSLATIONS = {
  de: {
    ...
    empf_hint: "Die hier gezeigten Empfehlungen basieren auf den Richtlinien der WHO (2019) sowie den Empfehlungen von Pro Juventute. Sie dienen als Orientierung – jedes Kind ist individuell.",
    ...
    empf_footer: "Weitere Informationen bei Pro Juventute Schweiz"
  },
  ...
  en: {
    ...
    empf_hint: "These recommendations are based on WHO guidelines (2019) and recommendations from Pro Juventute. They are meant as guidance – every child is different.",
    ...
    empf_footer: "More information from Pro Juventute Switzerland"
  }
};
    ...
    '<div class="nav-profile-dropdown" id="profileDropdown">' +
      ...
      '<div class="nav-profile-item nav-profile-item--lang">' +
        '<svg width="16" height="16" viewBox="0 0 16 16" fill="none">' +
          '<circle cx="8" cy="8" r="6" stroke="#7C6E61" stroke-width="1.3"/>' +
          '<path d="M8 2c0 0-3 2.5-3 6s3 6 3 6M8 2c0 0 3 2.5 3 6s-3 6-3 6M2 8h12" stroke="#7C6E61" stroke-width="1.3" stroke-linecap="round"/>' +
        '</svg>' +
      ...
      '<button class="nav-profile-item" onclick="openPasswordModal()">' +
        '<svg width="16" height="16" viewBox="0 0 16 16" fill="none">' +
          '<rect x="3" y="7" width="10" height="7" rx="2" stroke="#7C6E61" stroke-width="1.3"/>' +
          '<path d="M5 7V5a3 3 0 016 0v2" stroke="#7C6E61" stroke-width="1.3" stroke-linecap="round"/>' +
        '</svg>' +
      ...
      '<button class="nav-profile-item nav-profile-item--logout" id="logoutBtn">' +
        '<svg width="16" height="16" viewBox="0 0 16 16" fill="none">' +
          '<path d="M6 14H3a1 1 0 01-1-1V3a1 1 0 011-1h3M10 11l3-3-3-3M13 8H6" stroke="#e05260" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>' +
        '</svg>' +
...
function openPasswordModal() {
  var overlay =
    document.getElementById("navPasswordModalOverlay") ||
...
function savePassword() {
  ...
  if (!curr || !newPw || !conf) {
    return alert(getSharedT("pwFillAll"));
  }

  if (newPw !== conf) {
    return alert(getSharedT("pwNoMatch"));
  }
